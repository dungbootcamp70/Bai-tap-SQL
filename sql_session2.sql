...
inner join like_res lr on r.res_id = lr.user_id
...
inner join orders o on u.user_id = o.user_id
inner join like_res lr on u.user_id = lr.user_id
inner join rate_res rr on u.user_id = rr.user_id
LEFT JOIN like_res ON u.user_id = lr.user_id
LEFT JOIN rate_res ON u.user_id = rr.user_id
LEFT JOIN orders ON u.user_id = o.user_id    
WHERE 
    lr.user_id IS NOT NULL 
